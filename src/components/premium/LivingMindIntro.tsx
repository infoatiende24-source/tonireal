...
export default function LivingMindIntro() {
  ...
  return (
    <section aria-label="Introducción Toni Real. Usa el desplazamiento para avanzar." className="fixed inset-0 z-[100] overflow-hidden bg-[#020202] text-[#f7f1e7]">
      ...
      <div className="pointer-events-none absolute inset-0 hidden overflow-hidden sm:block [perspective:1500px]">
        <div className="absolute left-1/2 top-1/2 h-[105vh] w-[33vw] min-w-[340px] rounded-[4px] border border-[#e6c583]/[.16] bg-[linear-gradient(115deg,rgba(255,255,255,.10),rgba(207,165,90,.025)_28%,rgba(0,0,0,.12)_68%,rgba(255,255,255,.035))] shadow-[inset_1px_0_0_rgba(255,246,220,.14),0_30px_110px_rgba(0,0,0,.55)] backdrop-blur-[2px] transition-transform duration-700 ease-out" style={{ transform: leftTransform }} />
        <div className="absolute left-1/2 top-1/2 h-[105vh] w-[33vw] min-w-[340px] rounded-[4px] border border-[#e6c583]/[.16] bg-[linear-gradient(245deg,rgba(255,255,255,.10),rgba(207,165,90,.025)_28%,rgba(0,0,0,.12)_68%,rgba(255,255,255,.035))] shadow-[inset_-1px_0_0_rgba(255,246,220,.14),0_30px_110px_rgba(0,0,0,.55)] backdrop-blur-[2px] transition-transform duration-700 ease-out" style={{ transform: rightTransform }} />
      </div>
