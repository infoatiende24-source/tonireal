      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
        ...
        >
          <h2 className="font-display text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight">
            ¿Qué parte de tu negocio te está{" "}
            <span className="text-gradient-gold">robando más energía</span>?
          </h2>

          <p className="text-[#a09888] text-lg leading-relaxed max-w-2xl mx-auto">
            Lo miramos juntos y, si tiene sentido, diseñamos un sistema que quite
            ruido, atienda mejor a tus clientes y te devuelva tiempo.
          </p>
