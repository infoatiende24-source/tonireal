      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
        ...
        >
          <h2 className="font-display text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight">
            ¿Listo para dejar de perder ventas por{" "}
            <span className="text-gradient-gold">no contestar a tiempo</span>?
          </h2>

          <p className="text-[#a09888] text-lg leading-relaxed max-w-2xl mx-auto">
            Cada día que pasa sin automatizar tu WhatsApp es dinero que se va a
            tu competencia. Una conversación de 10 minutos puede cambiarlo todo.
          </p>
          ...
          <a
            ...
            className="btn-premium btn-premium-gold text-base inline-flex"
          >
